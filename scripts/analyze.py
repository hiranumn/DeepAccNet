    ...
    for d in dirs:
        ...
        for s in samples:
            ...
            if not args.ensemble:
                ...
                prediction = {}
                for tag in ["lddt", "estogram", "mask", "lddt_true", "estogram_true", "mask_true"]:
            ...
            temp["esto_xent"] = xentropy(prediction["estogram"], prediction["estogram_true"])
            temp["mask_xent"] = bxentropy(prediction["mask"], prediction["mask_true"])
